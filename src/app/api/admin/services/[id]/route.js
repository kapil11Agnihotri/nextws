...
export async function DELETE(req, context) {
  ...
  try {
    response = await serviceModel.delete_service(context?.params.id);

    // revalidatePath -> fetch the latest data from the db and replace it by stale data even if it is static page after build
