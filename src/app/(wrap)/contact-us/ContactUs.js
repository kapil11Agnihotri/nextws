...
function ContactUs() {
  ...
  const contactUsBanner = [
    {
      ...
      content:
        "We're not just another IT company – we're your trusted partner in tech success.",
      featured_image: "/contactus_banner.jpg",
    },
  ];
  ...
  return (
    <>
      <ContactUsBanner data={contactUsBanner} />
      <hr style={{ margin: "2% 5%" }} />
            ...
            <div className={styles.rightSection}>
              <div className={styles.rightInnerSection}>
                <div
                  ...
                  id='getInTouch'
                  onClick={() => {
                    window.location.href = "tel:+16198157158";
                  }}
                >
                ...
                <div
                  ...
                  id='sendEmail'
                  onClick={() => {
                    window.location.href = "mailto:hello@webanix.com";
                  }}
                >
      ...
      <div className={styles.downContainer}>
        ...
        <div className={styles.column3}>
          <div>
            ...
            <p> 2810 N Church St Wilmington, Delaware 19802-4447</p>
          </div>
          <div>
            <RiMapPin2Line size={25} />
            <span> India</span>
            <p> Panchwati, Udaipur</p>
          </div>
        </div>
      </div>
    </>
