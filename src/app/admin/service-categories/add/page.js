      ...
      try {
        ...
        if (response.code === 201) {
          ...
          router.push("/admin/service-categories");
            ...
            showErrorToast(
                response?.message ||  'Category creation error!'
            );
          }
        } catch (error) {
          // Handle login error
          showErrorToast('Category creation error!');
        }
    },
  });
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              >
                {/* <div className="d-flex justify-content-start">
                  <Button text="Back" link="admin/service-categories" icon="left" />
                </div> */}
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-12">
                        <div className="form-group">
                          <Editor
                            ...
                            className="form-control"
                            placeholder="Content*"
                            onTextChange={(newContent)=>formik.setFieldValue("content",newContent.htmlValue)}
                      ...
                      <div className="col-12 text-end">
                        ...
                        <button
                          type="button"
                          id="service_categories_add_close_button"
                        ...
                        <button
                          type="submit"
                          id="service_categories_add_submit_button"
                          className="btn"
                          style={{
