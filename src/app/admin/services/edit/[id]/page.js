                        ...
                        <div className="form-group">
                          ...
                          {showFeaturedImage ? (
                            ...
                            <Image
                              ...
                              height={70}
                              className="mt-2"
                              src={`${process.env.NEXT_PUBLIC_IMAGES_URL}/services/${formik?.values?.featured_image}`}
                              alt="featured image"
                              loading="lazy"
                            />
                          ) : (
                            ...
                            <div className="form-group">
                              ...
                              formik.values?.tech_images[index].image !== "" ? (
                                <Image
                                  ...
                                  height={70}
                                  className="mt-2"
                                  src={`${process.env.NEXT_PUBLIC_IMAGES_URL}/services/${formik?.values?.tech_images[index]?.image}`}
                                  // src={
                          ...
                          <div className="">
                            ...
                            {showOgImage ? (
                              ...
                              <Image
                                ...
                                height={70}
                                className="mt-2"
                                src={`${process.env.NEXT_PUBLIC_IMAGES_URL}/services/${formik?.values?.og_image}`}
                                alt="og image"
                                loading="lazy"
                              />
                            ) : (
