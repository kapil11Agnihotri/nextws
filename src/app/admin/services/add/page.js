  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const object = {
        ...
        tech_images_alt: values?.tech_images?.map((techItem) => techItem.alt),
      };
      ...
      try {
        ...
        if (response.code === 201) {
          showSuccessToast("New service created!");
          router.push("/admin/services");
        } else if (response.code === 422) {
          showErrorToast(response?.message?.issues[0]?.message);
        } else {
          showErrorToast(response?.message || "Service creation error!");
        }
      } catch (error) {
        // Handle login error
        showErrorToast("Service creation error!");
      }
    },
  });
                          ...
                          <div className="col-md-6 col-sm-12">
                            <div className="">
                              <button
                                ...
                                type="button"
                                id={`descriptionSection_addcard_${index}`}
                                onClick={() => {
                              ...
                              <button
                                className="btn btn-primary m-2"
                                type="button"
                                id={`descriptionSection_removecard_${index}`}
                                onClick={() => {
                                  handleServiceManipulation(
                                    "description",
                                    index,
                          ...
                          <div className="col-md-6 col-sm-12">
                            <div className="">
                              <button
                                className="btn btn-primary m-2"
                                type="button"
                                id={`techImagesSection_addcard_${index}`}
                                onClick={() => {
                                  handleServiceManipulation(
                                    "tech_images",
                                    index,
                              ...
                              <button
                                className="btn btn-primary m-2"
                                id={`techImagesSection_removecard_${index}`}
                                type="button"
                                onClick={() => {
                                  handleServiceManipulation(
                                    "tech_images",
